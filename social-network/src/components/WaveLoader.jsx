...
const WaveLoader = () => {
    return (
        <div className="wave-loader-container">
            <svg id="wave" data-name="Layer 1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 42.5 48">
                ...
                {/* Added expanded lines if needed based on CSS loop up to 9, but SVG only has 6. Logic in CSS handles available IDs. */}
            </svg>
        </div>
    );
};
